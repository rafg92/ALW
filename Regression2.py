...
if(__name__ == "__main__"):
    ...
    while(fsSize >= threshold):
        ...
        clfs = [MLPRegressor(solver='lbfgs', alpha=10, hidden_layer_sizes=(100,), random_state=1, activation="tanh",epsilon=1e-4, early_stopping=True),
                MLPRegressor(solver='adam', alpha=10, hidden_layer_sizes=(100,), random_state=1, activation="tanh",epsilon=1e-4, early_stopping=True),
                MLPRegressor(solver='sgd', alpha=10, hidden_layer_sizes=(100,), random_state=1, activation="tanh",epsilon=1e-4, early_stopping=True),
